...
class ArithmeticListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by ArithmeticParser#base.
    def enterBase(self, ctx:ArithmeticParser.BaseContext):
        pass

    # Exit a parse tree produced by ArithmeticParser#base.
    def exitBase(self, ctx:ArithmeticParser.BaseContext):
        pass
